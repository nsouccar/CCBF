...
//  CCBF
//
//  Created by Noa on 9/18/19.
//  Copyright © 2019 Noa Souccar. All rights reserved.
//

import UIKit

class ShareBar: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    let cellId = "cellId"
    let imageNames = ["schedule","authors", "genres", "sponsor"]
